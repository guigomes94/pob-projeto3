...
public class GenreFormController implements Initializable {
	...
	public void onBtnSaveAction(ActionEvent event) {
		...
		try {
			entity = getFormData();
			Facade.inicializar();
			Facade.saveOrUpdateGenre(entity.getName());
			Facade.finalizar();
	...
	public void setGenre(Genre entity) {
		this.entity = entity;
	}
